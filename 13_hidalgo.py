...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Hidalgo"""
    ...
    print("Step 1: Cargando dataset de centroides de Hidalgo...")
    ...
    x = x[(x['edo'] == "13")]
    print(f"Registros para Hidalgo: {len(x)}")
    
    print("Step 4: Limpiando datos...")
    x = x.drop(["edo"], axis=1)
    
    print("Step 5: Descargando datos climáticos para...")
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/13_hidalgo/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_13_hidalgo.csv'
