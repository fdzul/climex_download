...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Estado de Nuevo León"""
    ...
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/19_nuevo_leon/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_19_nuevo_leon.csv'
