...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Estado de Nayarit"""
    ...
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/18_nayarit/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_18_nayarit.csv'
