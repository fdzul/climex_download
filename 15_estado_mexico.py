...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Estado de México"""
    ...
    print("Step 1: Cargando dataset de centroides de estado de México...")
    ...
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/15_estado_mexico/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_15_estado_mexico.csv'
