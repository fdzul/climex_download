...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Durango"""
    ...
    print("Step 1: Cargando dataset de centroides de Durango...")
    ...
    x = x[(x['edo'] == "10")]
    print(f"Registros para Durango: {len(x)}")
    
    print("Step 4: Limpiando datos...")
    x = x.drop(["edo"], axis=1)
    
    print("Step 5: Descargando datos climáticos para...")
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/10_durango/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_10_durango.csv'
