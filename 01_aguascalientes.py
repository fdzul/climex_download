...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Aguascalientes"""
    ...
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/01_aguascalientes"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_01_aguascalientes.csv'
