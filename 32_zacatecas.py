...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Estado de Zacatecas"""
    ...
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/32_zacatecas/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_32_zacatecas.csv'
