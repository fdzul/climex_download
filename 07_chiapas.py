...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Chiapas"""
    ...
    print("Step 3: Extrayendo estado de chiapas...")
    x = x[(x['edo'] == "07")]
    print(f"Registros para Chiapas: {len(x)}")
    
    print("Step 4: Limpiando datos...")
    x = x.drop(["edo"], axis=1)
    
    print("Step 5: Descargando datos climáticos para Chiapas...")
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/07_chiapas/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_07_chiapas.csv'
