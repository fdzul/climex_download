...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Guerrero"""
    ...
    print("Step 1: Cargando dataset de centroides de Guerrero...")
    ...
    x = x[(x['edo'] == "12")]
    print(f"Registros para Guerrero: {len(x)}")
    
    print("Step 4: Limpiando datos...")
    x = x.drop(["edo"], axis=1)
    
    print("Step 5: Descargando datos climáticos para...")
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/12_guerrero/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_12_guerrero.csv'
