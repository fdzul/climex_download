...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Guanajuato"""
    ...
    print("Step 1: Cargando dataset de centroides de Guanajuato...")
    ...
    x = x[(x['edo'] == "11")]
    print(f"Registros para Cdmx: {len(x)}")
    
    print("Step 4: Limpiando datos...")
    x = x.drop(["edo"], axis=1)
    
    print("Step 5: Descargando datos climáticos para...")
    path_data = "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective/11_guanajuato/"
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_11_guanajuato.csv'
