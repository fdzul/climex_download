...
def main():
    """Función principal para descargar datos climáticos de NASA POWER para Coahuila"""
    ...
    output_file = '/Users/fdzul/Library/CloudStorage/Dropbox/dataset/nasa_power/climex_download/data/prospective_dataclim_05_coahuila.csv'
